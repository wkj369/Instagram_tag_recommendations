...
def Myword2vec(result):
    ...
    # 시각화1
    sns.set(style='whitegrid', font='NanumGothic', font_scale=1)
    #fm.get_fontconfig_fonts()
    #font_location = '/usr/share/fonts/truetype/nanum/NanumGothic.ttf'
    #font_location = 'static/font/NanumGothic.ttf'
    #font_name = fm.FontProperties(fname=font_location).get_name()
    #plt.rc('font', family=font_name)
    #sns.set(style='whitegrid', font=font_name, font_scale=1)
    #sns.set(style='whitegrid', font=font_name, rc={"axes.unicode_minus":False}, font_scale=1)
